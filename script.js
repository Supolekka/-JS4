...
function exportStr() { return `name = ${this.name} populatiion = ${this.population} жителей` }
...
console.log('5)',city1.exportStr());
console.log('5)',city2.exportStr());
console.log('5)',city1.getCity());
console.log('5)',city2.getCity());
